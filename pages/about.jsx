    ...
    <div className="flex flex-col justify-center items-center pt-2 w-screen lg:max-w-3xl">
      ...
      <div className="card w-96 bg-base-100 shadow-xl">
        <div className='flex items-center space-x-2 p-3'>
          ...
          <div>
            ...
            <p className='text-base-content/70 text-xs text-left pl-3 prose'>
              I&apos;m a 27 years old self-taught dev &amp; sysadmin building stuff.
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center">
            ...
            <progress className="progress w-full" value="66" max="100"></progress>
          </div>
          <div className="flex items-center">
            <span className='text-base-content/70 w-48 text-xs'>Sysadmin</span>
            <progress className="progress w-full" value="42" max="100"></progress>
          </div>
          <div className="flex items-center">
          ...
          <div className="flex items-center">
            ...
            <progress className="progress w-full" value="22" max="100"></progress>
          </div>
          <div className="flex items-center">
            <span className='text-base-content/70 w-48 text-xs'>Tailwindcss</span>
            <progress className="progress w-full" value="42" max="100"></progress>
          </div>
          <div className="flex items-center">
            <span className='text-base-content/70 w-48 text-xs'>Python</span>
            <progress className="progress w-full" value="21" max="100"></progress>
          </div>
          <div className="flex items-center">
            <span className='text-base-content/70 w-48 text-xs'>Rust</span>
            <progress className="progress w-full" value="33" max="100"></progress>
          </div>
          <div className="flex items-center">
